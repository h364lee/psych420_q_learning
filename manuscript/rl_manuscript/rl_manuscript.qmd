...
Schultz et al., (1997) provided the computational interpretation of these findings, demonstrating that the observed pattern of dopaminergic activity maps precisely onto the TD error signal $\delta__t$ (see @eq-td-error): a measure of descrepancy bewteen expected and predicted reward. This was not merely an analogy
