...
## Computational Psychiatry Extension
@fig-learning presents the learning curves and TD error signal across 500 episodes for all four agent profiles (see @tbl-agents), averaged over 20 independent runs. 

![Learning curves and TD error across agent profiles](images/graph3.png){#fig-learning width="100%"}

@fig-qvalues presents Q-value heatmaps for each agent profile following training.
