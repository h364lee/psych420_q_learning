...
### Early Computational and Theoretical DevelopmentsBy the mid-twentieth century, reinforcement learning became more formally defined with the introduction of computational models of decision making. Richard Bellman and fellow colleagues’ work on dynamic programming provided various ways to describe how optimal decision can be made by considering future outcomes (predictions) (Bellman, 1957; Sutton & Barto, 2020). His formulation of the Bellman equation offered a way to evaluate actions based on long-term consequences. 
...
### Motivation of Reinforcement learning Motivation refers to the underlying rationale for adopting a system or model, and the specific problems it is designed to address. Reinforcement learning (RL) is motivated by the need to enable systems to learn from experience, adapt to dynamic environments, and make informed decisions without explicit supervision. 
